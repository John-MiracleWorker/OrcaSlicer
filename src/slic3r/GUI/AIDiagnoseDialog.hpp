#ifndef slic3r_AIDiagnoseDialog_hpp_
#define slic3r_AIDiagnoseDialog_hpp_
...
class AIDiagnoseDialog : public DPIDialog
{
public:
    AIDiagnoseDialog(wxWindow* parent);
    ~AIDiagnoseDialog();
...
private:
    ...
    std::string load_photo_base64() const;
    ...
    wxFilePickerCtrl* m_photo_picker;
...
#endif // slic3r_AIDiagnoseDialog_hpp_
