...
void MainFrame::init_menubar_as_editor()
{
    ...
    m_topbar->AddDropDownSubMenu(aiMenu, _L("AI"));
    ...
    append_menu_item(
        ...
        [this](wxCommandEvent&) {
            wxLaunchDefaultBrowser("https://github.com/OrcaSlicer/OrcaSlicer/wiki/Calibration", wxBROWSER_NEW_WINDOW);
        },
        "", nullptr,
        [this]() {
            return m_plater->is_view3D_shown();
