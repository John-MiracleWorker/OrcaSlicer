...
private:
    ...
    std::unique_ptr<GUI::AIPrintMonitor> m_ai_monitor;
...
public:
    ...
    GUI::AIPrintMonitor* get_ai_monitor() const { return m_ai_monitor.get(); }
...
public:
    // to remove
    MachineObject* insert_local_device(
